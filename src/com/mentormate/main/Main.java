...
public class Main {
	public static void main(String[] args) throws Exception{
		...
		//For testing purposes with IDE
//		String dataFilePath = "Enter data.json file path here";
//		String definitionFilePath = "Enter file path here";				
